...
# /home/kris/Project/Proposed-working/CodeCrafter/evaluator
# -*- coding:utf-8 -*-
import argparse
import os
from CodeBLEU import weighted_ngram_match, bleu, dataflow_match, syntax_match
# from
...
def get_codebleu(refs, hyp, lang, params='0.25,0.25,0.25,0.25'):
    ...
    keywords = [x.strip() for x in open(root_dir + '/CodeBLEU/keywords/' + lang + '.txt', 'r', encoding='utf-8').readlines()]
    ...
    '''print('ngram match BLEU: {0}, weighted ngram match: {1}, syntax_match: {2}, dataflow_match: {3}'. \
          format(ngram_match_score, weighted_ngram_match_score, syntax_match_score, dataflow_match_score))'''
    print('BLEU score: ', ngram_match_score)
