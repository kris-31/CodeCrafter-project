"""
Finetune codecrafter model on any Seq2Seq LM tasks
"""
...
def load_tokenize_data(args):
    ...
    if os.path.exists(args.cache_data):
        ...
        datasets = load_dataset("code_x_glue_ct_code_to_text", 'python', split="train")   #change dataset
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=" finetuning on Seq2Seq LM task")
